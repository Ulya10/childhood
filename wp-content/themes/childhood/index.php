            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('photo_team');?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('cantfind_bold');?></span><?php the_field('cantfind');?>
                        </div>
                    </div>
                </div>
            </div>
...
add_filter('filter', 'filter_function');

echo apply_filters( 'filter', 'World' );

remove_filter( 'filter', 'filter_function');
